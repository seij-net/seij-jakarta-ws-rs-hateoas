...
@Path("/products-manual-generation")
public class ProductManualGenerationResource {
                ...
                .map(it -> {
                    Link selfProductLink = Links.fromUriBuilder("self",
                            uriInfo.getBaseUriBuilder()
                                    .path(ProductManualGenerationResource.class)
                                    .path(ProductManualGenerationResource.class, "findById")
